			...
			<div class="grid2C ratio3-2 topMargin darkGreen">
				<?php foreach ($treatments as $treatment) { ?>
					<div class="item">
						...
						<span class="extraSmall contact"><a class="uppercase" href="mailto:<?= $site->email()->url() ?>?subject=Anfrage zu <?= $treatment->name()->html() ?>">Behandlung anfragen</a></span>
					</div>
					<div class="item">
						<div class="width100 doubleColumns">
							<div class="data strongTopBorder darkGreen vSmallPadding">
