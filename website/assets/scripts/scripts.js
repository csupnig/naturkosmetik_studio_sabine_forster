...
var sharenetworks = {
  ...
  'linkedin' : 'ttps://www.linkedin.com/sharing/share-offsite/?url='
};

function shareIt(url, network){
  var nw = sharenetworks[network];
  if (nw) {
    var url = nw + url;
    SHAREWINDOW = window.open(url, 'network', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');
  }
  return false;
}
